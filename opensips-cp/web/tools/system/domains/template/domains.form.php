...
form_generate_input_text("SIP Port", "SIP Port",
	"port", "n", $domain_form['port'], 20, "^[0-9]{2,10}+$");

form_generate_input_text("Description", "Description",
	"description", "n", $domain_form['description'], 20, "");
